...
fn parse_path_to_tuple_svp(path: &Path) -> (&str, u32, u64, u32, &str) {
    ...
    (algo, all_dim, seed, dim, delta)
}
fn main() {
    println!("algo,all_dim,seed,dim,delta,sec,len,cnt");
    ...
    for dir in &dirs {
        ...
        for file in &files {
            ...
            let (algo, all_dim, seed, dim, delta) = parse_path_to_tuple_svp(&path);
            println!(
                "{},{},{},{},{},{},{},{}",
